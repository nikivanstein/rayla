 ...
 *
 * Optional illustration: set `image: "img/wildshapes/<file>.jpg"` on any creature to
...
const WILDSHAPE_DATA = [
  {
    ...
    image: "img/wildshapes/eagle.jpg",
  ...
  },
  {
    ...
    skills: "Balance +27 (+16 racial), Climb +24, Hide +14, Listen +15, Spot +15, Swim +8",
    abilitiesText: [
    ...
    image: "img/wildshapes/snake.jpg",
  ...
  },
  {
    ...
    attack: "Bite +17 melee (1d8+4)",
    fullAttack: "Bite +17 melee (1d8+4) and 2 claws +11 melee (1d6+1) and 2 wings +11 melee (1d4+1)",
    ...
    image: "img/wildshapes/young-silver-dragon.jpg",
  ...
  },
  {
    ...
    attack: "Bite +16 melee (1d8+4)",
    fullAttack: "Bite +16 melee (1d8+4) and 2 claws +10 melee (1d6+1) and 2 wings +10 melee (1d4+1)",
    ...
    image: "img/wildshapes/juvenile-black-dragon.jpg",
  ...
  },
  {
    ...
    image: "img/wildshapes/juvenile-white-dragon.jpg",
  ...
  },
  {
    ...
    attack: "Bite +24 melee (2d6+7)",
    fullAttack: "Bite +24 melee (2d6+7) and 2 claws +18 melee (1d8+3) and 2 wings +18 melee (1d6+3) and tail slap +18 melee (1d8+9)",
    ...
    feats: "Alertness (+2 spot and listen), Hover, Improved Initiative (+4 Init), Iron Will (+2 will save), Weapon Focus (bite), Power Attack, Snatch",
    ...
    image: "img/wildshapes/young-blue-dragon.jpg",
  ...
  },
  {
    ...
    fullAttack: "Bite +22 melee (2d6+8) and 2 claws +16 melee (1d8+3) and 2 wings +16 melee (1d6+3) and tail slap +16 melee (1d8+10)",
    ...
    notes: "",
    image: "img/wildshapes/young-gold-dragon.jpg",
