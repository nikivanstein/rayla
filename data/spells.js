...
const SPELL_DATA = {
  ...
  1: {
    ...
    perDay: 6,
    prepared: [
      { name: "Faerie Fire", qty: 1, dc: 15, save: "None", cast: "1 Action", duration: "1 min/lvl (D)", range: "Long (400+40/lvl)", effect: "Outlines every creature in the area in light, negating concealment (blur, invisibility, etc.) and any miss chance against them. (PH229)" },
      { name: "Goodberry", qty: 1, dc: 15, save: "None", cast: "1 Action", duration: "1 day/lvl", range: "Touch", effect: "Turns 2d4 berries into food; each cures 1 hp and is a full meal (max 8 berries' worth of healing per day). (PH237)" },
      { name: "Camouflage", qty: 1, dc: 15, save: "None", cast: "1 Action", duration: "10 min/lvl", range: "Personal", effect: "Your coloration instantly shifts to match your surroundings, granting a strong bonus on Hide checks. (SpC43)" },
    ...
    alternatives: [
      { name: "Beget Bogun",  dc: 16, save: "None", cast: "1 Action", duration: "Instantaneous", range: "Touch", effect: "Infuses a small mannequin of vegetable matter with living magic, animating it as a loyal bogun servant. (SpC26)" },
  ...
  2: {
    ...
    perDay: 6,
    prepared: [
      { name: "Owl's Wisdom", qty: 1, dc: 16, save: "Will Neg. (Harmless)", cast: "1 Action", duration: "1 min/lvl", range: "Touch", effect: "Grants a +4 enhancement bonus to Wisdom for the duration. (PH259)" },
      ...
      { name: "Creeping Cold", qty: 1, dc: 16, save: "Fortitude Half", cast: "1 Action", duration: "3 rounds", range: "Close (25+5/2 lvl)", effect: "Freezes the sweat on the target's skin, dealing cold damage as ice crystals cut into flesh. The subject takes 1d6 cumulative points of cold damage per round (that is, 1d6 on the 1st round, 2d6 on the second, and 3d6 on the third). Only one save is allowed against the spell; if successful, it halves the the damage each round. (MOTW86)" },
      { name: "Snake's Swiftness, Mass", qty: 1, dc: 16, save: "Will Neg. (Harmless)", cast: "1 Action", duration: "Instantaneous", range: "Medium (100+10/lvl)", effect: "Each target allied creature (in 20 feat radius) can instantly do a melee or ranged attack without using an action. (SpC193)" },
    ...
    alternatives: [
      { name: "Restoration, Lesser", dc: 17, save: "Will Neg. (Harmless)", cast: "3 Rounds", duration: "Instantaneous", range: "Touch", effect: "Touch dispels a magical ability penalty on the subject, or repairs 1d4 points of ability damage. (PH272)" },
      { name: "Animate Fire", dc: 16, save: "None", cast: "1 Round", duration: "Conc., up to 1 rd/lvl", range: "Close (25+5/2 lvl)", effect: "Turns a Small or smaller quantity of open flame into a fire creature that fights for you. (OA97)" },
